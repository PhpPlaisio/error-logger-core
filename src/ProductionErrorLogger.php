...
/**
 * An error logger tah can be safely used on production environments. All data is written of the error log is written
 * to a file and any errors and exception during the error logging itself are suppressed.
 */
